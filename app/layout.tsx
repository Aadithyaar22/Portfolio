...
export const metadata: Metadata = {
  ...
  description:
    'Portfolio of Aadithya A R — B.Tech CSE (AI & ML) student at Global Academy of Technology, Bengaluru. Ranked 20th of 1,500+ teams in the Google Gen AI Academy (APAC), Cohort 2. Building production-grade RAG systems, autonomous AI agents, and medical AI. Targeting FAANG/MAANG ML Engineer roles.',
  keywords: [
    'Aadithya A R',
    'ML Engineer',
    'GenAI',
  ...
  openGraph: {
    ...
    title: 'Aadithya A R — ML Engineer & GenAI Builder',
    description: 'Production-grade AI systems engineer. Ranked 20th of 1,500+ teams — Google Gen AI Academy (APAC), Cohort 2. RAG pipelines, agentic systems, medical AI.',
